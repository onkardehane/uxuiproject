    ...
    return(
      <div className="exemain">
        ...
        <div class="col s3">
         ...
         <div class="col s5">
          <h1>1.Chest Day</h1>
          <p>WEIGHTS (if you can implement :30 second breaks)
                ...
                Incline Dumbbell Bench Press, 3 sets of 10
                    ...
                    CARDIO (see CARDIO section below)</p>
                    <br></br>
<br></br>
<br></br>
<br></br>
...
Seated Lat Pull Down, 3 sets of 10

Machine Row, 3 sets of 10

50 bent-over Dummbell Rows for time, each arm
